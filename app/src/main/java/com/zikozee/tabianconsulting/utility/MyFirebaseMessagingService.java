...
import com.zikozee.tabianconsulting.AdminActivity;
import com.zikozee.tabianconsulting.ChatActivity;
import com.zikozee.tabianconsulting.ChatroomActivity;
import com.zikozee.tabianconsulting.LoginActivity;
import com.zikozee.tabianconsulting.R;
import com.zikozee.tabianconsulting.RegisterActivity;
import com.zikozee.tabianconsulting.SettingsActivity;
import com.zikozee.tabianconsulting.SignedInActivity;
...
//	Log.d(TAG, "onMessageReceived: notification title: " + notificationTitle);
    ...
    private void sendChatmessageNotification(String title, String message, Chatroom chatroom){
        ...
        builder.setSmallIcon(R.drawable.tabian_consulting_logo)
                ...
                .setColor(ContextCompat.getColor(getApplicationContext(),R.color.blue4))
                .setAutoCancel(true)
                .setSubText(message)
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            String CHANNEL_ID = "my__unique__Channel;";
