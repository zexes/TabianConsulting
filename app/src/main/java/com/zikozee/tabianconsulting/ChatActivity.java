...
import com.zikozee.tabianconsulting.models.ChatMessage;
import com.zikozee.tabianconsulting.models.Chatroom;
import com.zikozee.tabianconsulting.models.User;
import com.zikozee.tabianconsulting.utility.ChatRoomListAdapter;
...
//                            + singleSnapshot.getValue());
    ...
    private String getTimestamp(){
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss'Z'", US);
